...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="#"><i class="fas fa-paint-brush"></i> Ganti Background User dan Admin</a>
  ...
  <div class="main-content">
    ...
    <div class="cards">
      ...
      <div class="card">
        <h3><i class="fas fa-paint-brush"></i> Ganti Background User dan Admin</h3>
        <p>Ubah latar belakang gambar halaman login untuk pepustakawan dan admin.</p>
      </div>
      <div class="card">
        <h3><i class="fas fa-user-check"></i> Verify Pepustakawan</h3>
        <p>Verifikasi pepustakawan yang ingin mendaftar untuk membuat akun.</p>
      </div>
    </div>
  </div>
</body>
